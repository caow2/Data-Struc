...
public class FirstCommonAncestor {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(FCA(root.left,root.right)); //1
        set = new HashSet<Integer>();
        System.out.println(FCA(root.left.left, root.left)); //2
        set = new HashSet<Integer>();
        System.out.println(FCA(root.right.left, root.right.right.left)); //3
        set = new HashSet<Integer>();
        System.out.println(FCA(root, root.right.right.left)); //1
    }
